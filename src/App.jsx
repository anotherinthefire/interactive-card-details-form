    ...
    <>
      <div className="thank-you flex flex-col items-center justify-center lg:h-screen max-w-lg mx-auto">
        ...
        <p className="text-slate-400 text-center">
          This is a frontend project, and I sincerely appreciate your effort in filling out this form. Please refrain from sharing your card information with anyone else.
        </p>
        <button
